# ---------------------------------------------------------
# Streamlit page for the ATLAS experimental collaboration.
#
# Lab-Collaboration folder: ``Experimental/CERN-ATLAS/``.
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Run dashboard UI for the (CERN, ATLAS) collaboration
# ---------------------------------------------------------
run_dashboard(
    lab="CERN",
    group="ATLAS",
