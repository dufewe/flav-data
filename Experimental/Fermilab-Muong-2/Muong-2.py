# ---------------------------------------------------------
# Streamlit page for the Fermilab Muong-2 experiment.
#
# Lab-Collaboration folder: ``Experimental/Fermilab-Muong-2/``.
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Run dashboard UI for the (Fermilab, Muong-2) experiment
# ---------------------------------------------------------
run_dashboard(
    lab="Fermilab",
    group="Muong-2",
