# ---------------------------------------------------------
# Streamlit page for the Belle experimental collaboration.
#
# Lab-Collaboration folder: ``Experimental/KEK-Belle/``.
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Run dashboard UI for the (KEK, Belle) collaboration
# ---------------------------------------------------------
run_dashboard(
    lab="KEK",
    group="Belle",
