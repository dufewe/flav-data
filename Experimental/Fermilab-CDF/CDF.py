# ---------------------------------------------------------
# Streamlit page for the CDF experimental collaboration.
#
# Lab-Collaboration folder: ``Experimental/Fermilab-CDF/``.
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Run dashboard UI for the (Fermilab, CDF) collaboration
# ---------------------------------------------------------
run_dashboard(
    lab="Fermilab",
    group="CDF",
